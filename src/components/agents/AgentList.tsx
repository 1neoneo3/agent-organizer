  ...
  return (
    <div>
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "20px" }}>
        <h2 className="page-title-gradient" style={{ fontSize: "18px", fontWeight: 700, margin: 0 }}>Agents</h2>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
        {agents.map((agent) =>
          editingId === agent.id ? (
            ...
            <div
              key={agent.id}
              className={`glass-card animate-fade-in-up ${agent.status === "working" ? "agent-card-working agent-card-working-border" : "agent-card-idle"}`}
              style={{
                padding: "14px 16px",
                display: "flex",
                alignItems: "center",
              ...
              <div style={{ position: "relative" }}>
                ...
                <span
                  ...
                  style={{
                    ...
                    height: "10px",
                    borderRadius: "50%",
                    background: agent.status === "working" ? "#22c55e" : agent.status === "offline" ? "#ef4444" : "#a0a0a0",
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
                  ...
                  <span style={{
                    ...
                    fontSize: "10px",
                    fontWeight: 500,
                    color: agent.status === "working" ? "#4ade80" : agent.status === "offline" ? "#f87171" : "var(--text-tertiary)",
                    background: agent.status === "working" ? "rgba(34, 197, 94, 0.1)" : agent.status === "offline" ? "rgba(239, 68, 68, 0.1)" : "var(--bg-tertiary)",
                  }}>
                    {agent.status}
                  </span>
                </div>

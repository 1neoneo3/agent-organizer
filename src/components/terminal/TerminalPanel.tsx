  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", height: "100%" }}>
      <div
        ...
        style={{ flex: 1, overflowY: "auto", background: "rgba(8, 8, 14, 0.9)" }}
      >
        {text ? (
          <pre
            ref={preRef}
  ...
  return (
    <div style={{
      ...
      {isTerminalTab ? (
        ...
        <div ref={scrollRef} onScroll={handleScroll} style={{ flex: 1, overflowY: "auto", padding: "8px", background: "rgba(8, 8, 14, 0.9)" }}>
          {timeline.length === 0 && (
